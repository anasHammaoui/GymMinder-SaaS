...
<body class="bg-white">
    ...
    <div id="sidebar" class="fixed hidden top-0 left-0 h-full w-[260px] bg-white z-50 md:flex flex-col justify-between border-r border-gray-300">
        ...
        <nav class="flex-1">
            ...
            <li>
            <a href="{{ route('admin.finance') }}" class="flex items-center space-x-3 py-2 px-4 {{ request()->is('admin/finance') ? 'bg-gray-100 text-gray-800 font-medium' : 'text-gray-600 hover:bg-gray-100' }} rounded-lg">
